...
<jsp:setProperty name="actividadPS" property="*"/>
<%
 ...
 <%
     ...
     actividadPS.setFecha(fechaActividad);
    // actividadPS.setIdActividadPS(Integer.parseInt(request.getParameter("id")));
    
     if (actividadPS.getConvenio_id() == 0){
         %>
         <script type="text/javascript"> 
     ...
     if (actividadPS.getLider_codigoUFPS() == 0){
         %>
         <script type="text/javascript"> 
     ...
     boolean rta = false;
     if (!error){
         rta = facade.editarAPS(actividadPS);
     }
     ...
     if (rta){
         ...
         <script type="text/javascript"> 
            ...
            location.href="actividadProyeccion.jsp?actividad=<%=actividadPS.getIdActividadPS()%>";
         </script> 
         <%
